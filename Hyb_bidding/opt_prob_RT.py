...
def get_stoch_cvar_stairstep_prob_RT(esr_prop,gen_prop,poi,rt_vs_da,enforce_da_rt,eta_plus,eta_minus,plus_adder,minus_adder,priceDA,priceRTadd,gen,probS,cvar_weight,confid_lev,gridcharge,prSteps,np,pyo,Time_p,nscen_breaks):
    Lambda = rt_vs_da
    (nS,nT)=priceDA.shape
